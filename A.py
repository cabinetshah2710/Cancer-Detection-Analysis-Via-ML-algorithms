...
@app1.route("/developer" , methods =['POST'])
def reg1():
...
@app1.route("/home" , methods = ['POST'])
def back():
    return render_template("/allset.html")

@app1.route("/allset" , methods = ['GET'])
def predict_again():
    return render_template("/allset.html") 

@app1.route("/home" , methods = ['GET'])
def feed_back():
    return render_template("/allset.html")

@app1.route("/demo", methods = ['POST'])
def upload():
    return render_template("/demo.html")

@app1.route("/demo", methods = ['GET'])
def upload1():
    return render_template("/demo.html")
...
@app1.route('/prediction1',methods=['POST'])
def prediction1():
...
@app1.route('/index', methods=['GET'])
def dd():
    return render_template('/index.html')


@app1.route('/pcpaccuracy', methods=['GET'])
def dd1():
...
@app1.route('/bcpaccuracy', methods=['GET'])
def pcpacc():
...
@app1.route('/bcpindex', methods=['GET'])
def pcpacc1():
    return render_template('/bcpindex.html')

@app1.route('/bcpindex', methods=['POST'])
def pcpacc2():
    return render_template('/bcpindex.html')

# lung cancer prediction 
@app1.route("/lcpaccuracy" ,methods = ['POST'])
def chart():
...
@app1.route("/lcpindex" ,methods = ['POST'])
def lcp():
    return render_template("lcpindex.html")

@app1.route("/lcpindex" ,methods = ['GET'])
def chart12():
    return render_template("lcpindex.html")
...
@app1.route("/analysis" , methods = ['POST'])
def uploaded():
...
@app1.route("/analysis1" , methods = ['POST'])
def uploaded1():
    if request.method == "POST" :
...
@app1.route("/visualize" , methods = ['POST'])
def visualize():
...
@app1.route("/visualize1" , methods = ['POST'])
def visualize1():   
...
@app1.route("/analysis" , methods = ['GET'])
def get_back():
    return render_template("analysis.html")

@app1.route("/analysis1" , methods = ['GET'])
def get_back1():
